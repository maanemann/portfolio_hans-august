...
const themes = {
  ockerdust: {
    ...
    textA4Theme: 'text-ockerdust-600/75',
    ...
    borderDarkerTheme: 'border-ockerdust-800/50',
    ...
    bgBrightBTrTheme: 'bg-ockerdust-800/25',
  ...
  aqua: {
    ...
    borderDarkerTheme: 'border-aqua-800/50',
    ...
    bgBrightBTrTheme: 'bg-aqua-800/25',
